...
def add_arguments():
    ...
    parser.add_argument('--env_name', type=str, default='Cage',
...
class PPO_Cage:
    def __init__(self, args):
        self.args = args
        self.env = ChallengeWrapper(env=cyborg,agent_name='Red')
        #_ = self.env.reset()
        #traci.close()
        ...
        #print(list(self.env.get_action_space('blue')), self.env.observation_space)
